...
class Maquinas extends Component {
  ...
  seleccion= boton =>()=>{
    switch(boton){
      case 'uno':
        window.location.href = '/user/busqueda/01';
      break;
      case 'dos':
        window.location.href = '/user/busqueda/02';
      break;
      case 'tres':
        window.location.href = '/user/busqueda/03';
      break;
      case 'cuatro':
        window.location.href = '/user/busqueda/04';
      break;
      case 'cinco':
        window.location.href = '/user/busqueda/05';
      break;
      case 'seis':
        window.location.href = '/user/busqueda/06';
      break;
      case 'siete':
        window.location.href = '/user/busqueda/07';
      break;
      case 'ocho':
        window.location.href = '/user/busqueda/08';
      break;
      case 'nueve':
        window.location.href = '/user/busqueda/09';
      break;
